(function() {
  var chapterList, chapterName, chapterOrder, destination, docco_styles, docco_template, ensure_directory, exec, ext, file, fileStr, fs, generate_documentation, generate_html, get_language, highlight, highlight_end, highlight_start, l, languages, parse, parseKey, path, showdown, sources, spawn, template, _i, _len, _ref;
  ...
  for (_i = 0, _len = sources.length; _i < _len; _i++) {
    ...
    chapterList[chapterName].push({
      path: file,
      order: chapterOrder
    });
    chapterList[chapterName].sort(function(a, b) {
      var _ref2;
